    ...
    return (
        <div className="relative min-h-screen bg-slate-50 dark:bg-slate-950 flex items-center justify-center overflow-hidden transition-all duration-300">
            ...
            <div className="absolute top-0 left-0 w-full h-full pointer-events-none">
                <div className="absolute top-10 right-1/4 w-[500px] h-[500px] bg-emerald-500/10 dark:bg-emerald-500/5 rounded-full blur-3xl" />
            </div>
            ...
            >
                ...
                <div className="text-center mb-8">
                    ...
                    <h2 className="text-2xl font-bold text-slate-900 dark:text-slate-100">Create Admin Account</h2>
                ...
                <form onSubmit={handleSignup} className="flex flex-col gap-4">
                    ...
                    <div>
                        <label className="text-xs font-medium text-slate-600 dark:text-slate-400 mb-1.5 block">Store Name</label>
                        <input
                            type="text"
