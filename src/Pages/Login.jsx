  ...
  return (
    <div className="relative min-h-screen bg-slate-50 dark:bg-slate-950 flex items-center justify-center overflow-hidden transition-all duration-300">
      ...
      <div className="absolute top-0 left-0 w-full h-full pointer-events-none">
        <div className="absolute top-40 left-1/2 -translate-x-1/2 w-[500px] h-[500px] bg-emerald-500/10 dark:bg-emerald-500/5 rounded-full blur-3xl" />
      </div>
      ...
      >
        ...
        <form onSubmit={handleLogin} className="flex flex-col gap-4">
          ...
          {error && (
            <div className="bg-red-50 dark:bg-red-500/10 border border-red-200 dark:border-red-500 text-red-600 dark:text-red-400 px-4 py-2 rounded-lg mb-4 text-sm">
              {error}
            </div>
          )}
          ...
          <button
            type="submit"
            disabled={loading}
            className="mt-2 flex items-center justify-center gap-2 px-6 py-3 bg-emerald-500 hover:bg-emerald-600 text-white rounded-xl font-medium transition-all duration-200 hover:shadow-lg hover:shadow-emerald-500/25 disabled:opacity-50 disabled:cursor-not-allowed active:scale-95"
          >
            {loading ? (
          ...
          <div className="mt-4 flex flex-col items-center gap-2 text-sm text-slate-500">
            <p>
              New here?{" "}
              <Link to="/signup/user" className="text-emerald-600 dark:text-emerald-400 hover:text-emerald-500 dark:hover:text-emerald-300 font-medium transition-colors">
                Create User Account
              </Link>
            </p>
            <p>
              Owning a store?{" "}
              <Link to="/signup/admin" className="text-emerald-600 dark:text-emerald-400 hover:text-emerald-500 dark:hover:text-emerald-300 font-medium transition-colors">
